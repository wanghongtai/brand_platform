...
public class SysPositionMenu {
     ...
     * 获取菜单id对应sys_menu.id
     *
     * @return menu_id - 菜单id对应sys_menu.id
     */
     ...
     * 设置菜单id对应sys_menu.id
     *
     * @param menuId 菜单id对应sys_menu.id
     */
    ...
    /**
     * 获取职位id对应sys_position.id
     *
     * @return position_id - 职位id对应sys_position.id
     */
    ...
    /**
     * 设置职位id对应sys_position.id
     *
     * @param positionId 职位id对应sys_position.id
     */
