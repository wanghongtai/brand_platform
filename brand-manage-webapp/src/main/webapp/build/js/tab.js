                ...
                n.find("li.kit-item").each(function() {
                    ...
                    function() {
                        ...
                        case "closeAll":
                            ...
                            $.each($('.layui-tab-item'),function(){
                            	var id = $(this).attr('lay-item-id');
                            	if(id > -1){
                            		this.remove();
                            	}
                            });
