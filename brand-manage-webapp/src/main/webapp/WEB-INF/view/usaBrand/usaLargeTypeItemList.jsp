...
<script src="${cxtPath}/js/usaBrand/usaLargeTypeListItemList.js"></script>
<title>美国商标类子项目列表</title>
</head>
<body class="page_body">
	...
	<div>
		<table id="UsaLargeTypeItemTable" lay-filter="UsaLargeTypeItemTable"></table>
	</div>
	...
	<div class="allJurisdiction" id="allJurisdiction">
		<dl class="layui-nav-child layui-anim layui-anim-upbit">
			...
			<dd style="padding-left:20px;">
				<a href="${cxtPath}/excel/usa_demo.xls">下载excel</a>
			</dd>
		</dl>
	</div>
