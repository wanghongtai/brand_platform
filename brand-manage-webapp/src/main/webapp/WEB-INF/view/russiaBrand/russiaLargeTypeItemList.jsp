...
<script src="${cxtPath}/js/russiaBrand/russiaLargeTypeListItemList.js"></script>
<title>俄罗斯商标项目列表</title>
</head>
<body class="page_body">
				...
				<div class="layui-form-item">
					<div class="layui-inline page_tool_input">
						<div class="layui-input-inline input-width">
							<input type="text" id="title" class="input layui-input"
								placeholder="标题">
						</div>
	...
	<div>
		<table id="RussiaLargeTypeItemTable" lay-filter="RussiaLargeTypeItemTable"></table>
	</div>
	...
	<div class="allJurisdiction" id="allJurisdiction">
		<dl class="layui-nav-child layui-anim layui-anim-upbit">
			...
			<dd style="padding-left:20px;">
				<a href="${cxtPath}/excel/russia_demo.xls">下载excel</a>
			</dd>
		</dl>
	</div>
