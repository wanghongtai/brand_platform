...
<script src="${cxtPath}/js/navItem/navItemList.js"></script>
<title>商标导航列表</title>
</head>
<body class="page_body">
	...
	<div>
		<table id="NavItemTable" lay-filter="NavItemTable"></table>
	</div>
	...
	<script type="text/html" id="checkboxTpl">
  		<input type="checkbox" name="lock" value="{{d.id}}" title="显示" lay-filter="lockDemo" {{ d.showStatus == '0' ? 'checked' : '' }}>
	</script>
