...
<script src="${cxtPath}/js/auBrand/auLargeTypeListItemList.js"></script>
<title>澳洲商标项目列表</title>
</head>
<body class="page_body">
	...
	<div>
		<table id="JpLargeTypeItemTable" lay-filter="JpLargeTypeItemTable"></table>
	</div>
	...
	<div class="allJurisdiction" id="allJurisdiction">
		<dl class="layui-nav-child layui-anim layui-anim-upbit">
			...
			<dd style="padding-left:20px;">
				<a href="${cxtPath}/excel/au_demo.xls">下载excel</a>
			</dd>
		</dl>
	</div>
