...
<script src="${cxtPath}/js/korBrand/korLargeTypeListItemList.js"></script>
<title>日本商标项目列表</title>
</head>
<body class="page_body">
	...
	<div>
		<table id="KorLargeTypeItemTable" lay-filter="KorLargeTypeItemTable"></table>
	</div>
	...
	<div class="allJurisdiction" id="allJurisdiction">
		<dl class="layui-nav-child layui-anim layui-anim-upbit">
			...
			<dd style="padding-left:20px;">
				<a href="${cxtPath}/excel/kor_demo.xls">下载excel</a>
			</dd>
		</dl>
	</div>
