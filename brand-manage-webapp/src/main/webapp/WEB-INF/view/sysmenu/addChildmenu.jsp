	...
	<form class="layui-form editform" id="menuForm" style="margin: 20px;margin-top: 0px;">
				...
				<div class="layui-input-block">
					<select name="parentId">
						...
						<c:forEach items="${menuList}" var="menu">
							<option ${parentId eq menu.id ? "selected" :"" }  value="${menu.id }"  >${menu.name}</option>
						</c:forEach>
					</select>
				</div>
			</div>
		...
		<div class="layui-row">
			<div class="layui-col-xs11">
				...
				<div class="layui-input-block">
					<input type="text" name="url" value="${menuObj.url}" lay-verify="required" class="layui-input" placeholder="请填写菜单url">
				</div>
			</div>
		</div>
		<div class="layui-row">
		...
		<div class="layui-row">
			<div class="layui-col-xs11">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入内容" rows="10" class="layui-textarea" name="desc">${menuObj.desc}</textarea>
				</div>
			</div>
		</div>
