...
<script src="${cxtPath}/js/euroBrand/euroLargeTypeListItemList.js"></script>
<title>欧盟商标类子项目列表</title>
</head>
<body class="page_body">
	...
	<div>
		<table id="EuroLargeTypeItemTable" lay-filter="EuroLargeTypeItemTable"></table>
	</div>
	...
	<div class="allJurisdiction" id="allJurisdiction">
		<dl class="layui-nav-child layui-anim layui-anim-upbit">
			...
			<dd style="padding-left:20px;">
				<a href="${cxtPath}/excel/euro_demo.xls">下载excel</a>
			</dd>
		</dl>
	</div>
