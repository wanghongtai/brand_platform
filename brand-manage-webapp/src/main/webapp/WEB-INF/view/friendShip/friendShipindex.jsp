...
<style type="text/css">
	.layui-table-body .layui-table-cell{height:50px;line-height:50px;}
</style>
<jsp:include page="/html/baseCommon.jsp"></jsp:include>
<script src="${cxtPath}/js/friendShip/friendShipindex.js"></script>
<title>友情链接管理</title>
</head>
<body class="page_body">
				...
				<div class="layui-form-item">
					<div class="layui-inline page_tool_input">
						<div class="layui-input-inline input-width">
							<input type="text" id="name" class="input layui-input"
								placeholder="友情链接名称">
						</div>
	...
	<div class="allJurisdiction"
		id="allJurisdiction">
		<shiro:hasPermission name="cxbnxz">
